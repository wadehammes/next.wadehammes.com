...
export const Spiral: FC<SpiralProps> = ({
  ...
  count = randomIntFromInterval(2, 32),
  offset = randomIntFromInterval(30, 150),
  h = randomIntFromInterval(60, 360),
  s = `${randomIntFromInterval(10, 100)}%`,
  l = `${randomIntFromInterval(10, 100)}%`,
